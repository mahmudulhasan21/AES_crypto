...
INPUTtwo = "0023456789abcdeffedcba9876543210"
...
for i in range(10):
    for j in range(4):
        ...
        newInTwo[j] = tempInTwo[j] ^ w[i*4+0][j]
        newInTwo[j+4] = tempInTwo[j+4] ^ w[i*4+1][j]
        newInTwo[j+8] = tempInTwo[j+8] ^ w[i*4+2][j]
        newInTwo[j+12] = tempInTwo[j+12] ^ w[i*4+3][j]
...
for j in range(4):
    ...
    newInTwo[j] = tempInTwo[j] ^ w[40][j]
    newInTwo[j+4] = tempInTwo[j+4] ^ w[41][j]
    newInTwo[j+8] = tempInTwo[j+8] ^ w[42][j]
    newInTwo[j+12] = tempInTwo[j+12] ^ w[43][j]
